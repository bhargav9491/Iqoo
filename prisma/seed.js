...
async function main() {
  console.log('Seeding Northstar Systems enterprise workspace into SQLite database...');
  ...
  // Clear existing records for clean state
  ...
  // 1. PROJECT 1: Smart Infrastructure Monitoring
  ...
  // 2. PROJECT 2: Operations Workflow Automation
  ...
  await prisma.workContext.createMany({
    data: [
      ...
      },
      {
        projectId: project2.id,
        category: 'ATTEMPT',
        title: 'Failed Approach: Polling-Based Webhook Listener',
  ...
  // 3. PROJECT 3: Intelligent Asset Management
  ...
  console.log('Northstar Systems workspace seeded with 3 connected sample projects successfully!');
